...
class CardHeroAdapter(private var listLang: ArrayList<Lang>) :
    ...
    override fun onBindViewHolder(holder: CardViewHolder, position: Int) {
        ...
        holder.btnDetail.setOnClickListener { onItemClickCallback.onItemClicked(listLang[holder.adapterPosition]) }
    }
    ...
    inner class CardViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val btnDetail: Button = itemView.findViewById(R.id.btn_details)
    }
}